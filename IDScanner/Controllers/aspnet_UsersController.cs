...
namespace IDScanner.Controllers
{
    public class aspnet_UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ApplicationId,UserId,UserName,LoweredUserName,MobileAlias,IsAnonymous,LastActivityDate,FName,LName")] aspnet_Users aspnet_Users)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ApplicationId,UserId,UserName,LoweredUserName,MobileAlias,IsAnonymous,LastActivityDate,FName,LName")] aspnet_Users aspnet_Users)
        {
            if (ModelState.IsValid)
            {
